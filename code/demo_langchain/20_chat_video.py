...
avatar_url = "https://imagecache.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/92cfe628-70b8-42ec-a8ad-e451f23ff100/width=450/00193-3556647833.jpeg"
...
def get_mp4_video(input, avatar_url=avatar_url):
    ...
    while index < 30:
        ...
        if talk['status'] == 'error':
            print("generate video error: ", talk)
            return ""
